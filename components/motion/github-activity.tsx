...
const GitHubActivity = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative max-w-full overflow-hidden rounded-[28px] bg-white p-4 dark:bg-black border border-border/40 shadow-xl",
    ...
    >
      ...
      {repos.length > 0 && (
        <motion.div
          ...
          className={cn(
            "absolute inset-x-3 bottom-3 overflow-hidden bg-card/90 backdrop-blur-xl border border-border/60 shadow-lg",
            open && "top-3",
          )}
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="grid size-7 shrink-0 place-items-center rounded-full bg-card hover:bg-muted transition-colors"
              >
