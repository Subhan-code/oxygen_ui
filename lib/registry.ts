...
export const registry: CategoryEntry[] = [
  {
    ...
    description:
      "Production-ready Solana React UI primitives, Base58 validators, network monitors, token balances, transaction timelines, and dApp application surfaces.",
    components: [
      {
        slug: "identity",
        name: "Identity & Accounts",
        description: "Address displays, verified .sol badges, real-time Base58 validators, and public key inputs.",
        file: "components/solana/identity.tsx",
        badge: "new",
      ...
      },
      {
        ...
        file: "components/solana/network.tsx",
        badge: "new",
        launchedAt: "2026-08-05",
      },
      {
        ...
        file: "components/solana/assets.tsx",
        badge: "new",
        launchedAt: "2026-08-05",
      },
      {
        ...
        file: "components/solana/transactions.tsx",
        badge: "new",
        launchedAt: "2026-08-05",
      },
      {
        ...
        file: "components/solana/application.tsx",
        badge: "new",
        launchedAt: "2026-08-05",
      },
    ],
  ...
  {
    slug: "motion",
    name: "Motion Crypto Primitives",
    description:
      "Solana & Web3 React motion primitives, NFT cards, wallet action buttons, token price tickers, DEX tabs, and priority fee switches.",
    components: [
      {
        slug: "nft-tilt-card",
        name: "NFT Tilt Card",
      ...
      },
      {
        ...
        description: "Infinite horizontal or vertical scroll ticker for Solana tokens (SOL, BONK, JUP, RAY) with live price changes.",
        file: "components/motion/marquee.tsx",
      },
      {
        slug: "defi-dex-tabs",
        name: "DeFi DEX Tabs",
        description: "Pill, segment or underline tabs with a spring layoutId indicator for DEX Swap, Pools, and Perps.",
        file: "components/motion/tabs.tsx",
      },
      {
        slug: "protocol-switch",
        name: "Protocol Switch",
        description: "Toggle switch with spring feedback for Turbo Priority Fee, MEV Shield, and Dynamic Slippage.",
        file: "components/motion/switch.tsx",
      },
      {
        slug: "solana-address-input",
        name: "Solana Address Input",
        description: "Solana public key and transfer amount input with left/right token icons and error shake.",
        file: "components/motion/input.tsx",
      },
      {
        slug: "token-select",
        name: "Token Select",
        description: "Composable select primitives for Solana SPL token picking (SOL, USDC, BONK, JUP, RAY).",
      ...
      },
      {
        ...
        extraFiles: [
          ...
          "components/motion/blur-shimmer-text.tsx",
        ],
        examples: [
          {
            slug: "blur-shimmer",
            ...
            description:
              "Staggered character blur shimmer text reveal extracted from ratneshc.com.",
            badge: "new",
            launchedAt: "2026-08-06",
            installSlug: "blur-shimmer-text",
            file: "components/motion/blur-shimmer-text.tsx",
            previewKey: "motion/blur-shimmer-text",
            previewFile:
              "components/previews/motion/blur-shimmer-text.preview.tsx",
          },
          {
      ...
      },
      {
        ...
        file: "components/motion/add-member-dialog.tsx",
        badge: "new",
      ...
      },
      {
        ...
        file: "components/motion/dither-donut-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/gooey-droplet-sheet.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/dither-bar-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/direct-scrubber-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/hand-gestures.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/pipeline-board.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/members-plan-donut-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/payments-bar-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/members-line-chart.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/scroll-progress-sections.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/github-activity.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
        ...
        file: "components/motion/proximity-sidebar.tsx",
        badge: "new",
        launchedAt: "2026-08-07",
      },
      {
